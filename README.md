...
This system only enforces permissions for the storing of data. This is essential for an open source project where this is true:  Anyone can see the data logged at my Adirondack cabin using this system by visiting http://randomsprocket.com/weather. (Oh no, the data isn't flowing because the Moxee hotspot I'm using lacks a watchdog to reset it when it gets confused!  My next project is to make an ESP8266 reboot a hotspot when the internet fails.  See https://github.com/judasgutenberg/Hotspot-Watchdog.)
